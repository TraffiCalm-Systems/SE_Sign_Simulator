...
export class Simulation {
  ...
  async Init(window, useNewRemote) {
    ...
    this.remote = new Remote(useNewRemote);
    this.sign = new Sign();
    ...
    const importResults = await Promise.all([
      this.remote
        .Import()
        .catch((error) => ({ error, instance: remote, type: "Remote" })),
